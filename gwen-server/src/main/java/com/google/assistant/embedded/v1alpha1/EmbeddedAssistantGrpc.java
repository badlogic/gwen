 ...
 * </pre>
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.3.0)", comments = "Source: google/assistant/embedded/v1alpha1/embedded_assistant.proto")
public final class EmbeddedAssistantGrpc {
	...
	@io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901") public static final io.grpc.MethodDescriptor<com.google.assistant.embedded.v1alpha1.ConverseRequest, com.google.assistant.embedded.v1alpha1.ConverseResponse> METHOD_CONVERSE = io.grpc.MethodDescriptor
		.create(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
			generateFullMethodName("google.assistant.embedded.v1alpha1.EmbeddedAssistant", "Converse"),
	...
	public static EmbeddedAssistantBlockingStub newBlockingStub (io.grpc.Channel channel) {
		return new EmbeddedAssistantBlockingStub(channel);
	}

	/** Creates a new ListenableFuture-style stub that supports unary and streaming output calls on the service */
	public static EmbeddedAssistantFutureStub newFutureStub (io.grpc.Channel channel) {
	...
	public static abstract class EmbeddedAssistantImplBase implements io.grpc.BindableService {
		...
		public final io.grpc.ServerServiceDefinition bindService () {
			return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(METHOD_CONVERSE, asyncBidiStreamingCall(
				new MethodHandlers<com.google.assistant.embedded.v1alpha1.ConverseRequest, com.google.assistant.embedded.v1alpha1.ConverseResponse>(
	...
	public static final class EmbeddedAssistantStub extends io.grpc.stub.AbstractStub<EmbeddedAssistantStub> {
		...
		private EmbeddedAssistantStub (io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected EmbeddedAssistantStub build (io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
		...
		public io.grpc.stub.StreamObserver<com.google.assistant.embedded.v1alpha1.ConverseRequest> converse (
			io.grpc.stub.StreamObserver<com.google.assistant.embedded.v1alpha1.ConverseResponse> responseObserver) {
			return asyncBidiStreamingCall(getChannel().newCall(METHOD_CONVERSE, getCallOptions()), responseObserver);
		}
	}
	...
	public static final class EmbeddedAssistantBlockingStub extends io.grpc.stub.AbstractStub<EmbeddedAssistantBlockingStub> {
		...
		private EmbeddedAssistantBlockingStub (io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected EmbeddedAssistantBlockingStub build (io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
	...
	public static final class EmbeddedAssistantFutureStub extends io.grpc.stub.AbstractStub<EmbeddedAssistantFutureStub> {
		...
		private EmbeddedAssistantFutureStub (io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected EmbeddedAssistantFutureStub build (io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
		...
		public io.grpc.stub.StreamObserver<Req> invoke (io.grpc.stub.StreamObserver<Resp> responseObserver) {
			...
			case METHODID_CONVERSE:
				return (io.grpc.stub.StreamObserver<Req>)serviceImpl
					.converse((io.grpc.stub.StreamObserver<com.google.assistant.embedded.v1alpha1.ConverseResponse>)responseObserver);
			default:
				throw new AssertionError();
			}
		}
			...
			synchronized (EmbeddedAssistantGrpc.class) {
				...
				if (result == null) {
					serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
						.setSchemaDescriptor(new EmbeddedAssistantDescriptorSupplier()).addMethod(METHOD_CONVERSE).build();
				}
			}
		}
		return result;
