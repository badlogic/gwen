...
public class snowboyJNI {
	...
	public final static native int SnowboyDetect_RunDetection__SWIG_2 (long jarg1, SnowboyDetect jarg1_, float[] jarg2, int jarg3,
		boolean jarg4);

	public final static native int SnowboyDetect_RunDetection__SWIG_3 (long jarg1, SnowboyDetect jarg1_, float[] jarg2, int jarg3);

	public final static native int SnowboyDetect_RunDetection__SWIG_4 (long jarg1, SnowboyDetect jarg1_, short[] jarg2, int jarg3,
		boolean jarg4);

	public final static native int SnowboyDetect_RunDetection__SWIG_5 (long jarg1, SnowboyDetect jarg1_, short[] jarg2, int jarg3);

	public final static native int SnowboyDetect_RunDetection__SWIG_6 (long jarg1, SnowboyDetect jarg1_, int[] jarg2, int jarg3,
		boolean jarg4);
